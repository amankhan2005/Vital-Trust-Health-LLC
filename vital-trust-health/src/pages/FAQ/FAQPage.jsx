...
// --- 3. MAIN COMPONENT ---
const FAQPage = () => {
  const [activeId, setActiveId] = useState(1); // default open first item
      ...
      <Container>
        <div className="max-w-6xl mx-auto -mt-20 relative z-10 grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6 lg:sticky top-24 h-fit">
            ...
            {/* Info Card */}
            <div 
              className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 text-center group"
              data-aos="fade-right"
            >
              <div className="bg-teal-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5 text-[#3EB8A7] shadow-sm group-hover:scale-110 transition-transform duration-300">
                <IconQuestion />
              </div>
            ...
            {/* CTA Card */}
            <div 
              className="bg-gradient-to-br from-[#F97316] to-orange-600 text-white rounded-3xl p-8 shadow-xl relative overflow-hidden"
              data-aos="fade-right"
              data-aos-delay="100"
            >
              {/* Background Pattern */}
              ...
              <div className="relative z-10">
                ...
                <Link
                  to="/contact-us"
                  className="inline-flex items-center justify-center bg-white text-[#F97316] font-bold px-6 py-3 rounded-full shadow-md hover:scale-105 transition-transform duration-300"
                >
                  Contact Us
          ...
          <div className="lg:col-span-8" data-aos="fade-left">
            <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 p-6 md:p-8 space-y-4">
              {faqs.map((faq) => (
                <FAQItem
                  key={faq.id}
